<template>
    <v-row>
        <v-col cols="3" v-for="producto in productos" :key="producto.idProductos">
            <div class="movImgr oror">
...
export default {
    ...
    mounted() {
        axios.get('http://localhost:3000/productos?limit=11&offset=10').then((response) => {
